...
class LLMConfig:
    ...
    base_url: str = _env("OPENAI_API_BASE", "https://api.openai.com/v1")
...
class MemorySystemYamlConfig:
    ...
    def load_from_yaml(cls, yaml_path: str) -> "MemorySystemYamlConfig":
        ...
        try:
            ...
            llm_api_key = _env("OPENAI_API_KEY", "") or llm_data.get("api_key", "")
            llm_base_url = _env("OPENAI_API_BASE", "") or llm_data.get("base_url", "https://api.openai.com/v1")
