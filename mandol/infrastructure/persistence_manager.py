...
class PersistenceManager:
    ...
    def load_full(self) -> Tuple[List[Any], List[Any], List[Tuple[str, str, str, Dict[str, Any]]], List[Any], List[str], Set[str], Set[Tuple[str, str]]]:
        try:
            ...
            insertion_order, processed_session_ids, processed_similarity_pairs = self._engine.load_processed_state()
...
class MemorySystemStateLoader:
    ...
    def load_into_system(self, system: "MemorySystem") -> Optional[List[str]]:
        units, spaces, edges, sessions, insertion_order, processed_session_ids, processed_similarity_pairs = self._pm.load_full()
