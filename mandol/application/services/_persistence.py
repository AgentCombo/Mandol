...
class MemoryPersistenceService:
    ...
    def attach_state(
        ...
        *,
        ...
        Args:
            ...
            pending_units: Dict of pending MemoryUnits awaiting processing.
    ...
    def _load(self, storage_path: str) -> LoadResult:
        ...
        try:
            ...
            insertion_order, processed_session_ids, processed_similarity_pairs = engine.load_processed_state()
    ...
    def _rebuild_vector_index(self, units: List[MemoryUnit]) -> None:
        ...
        for space_name, space_items_list in space_items.items():
            self._abi.rebuild_space(space_name, space_items_list)
