...
- `location`: where the event happened (entity reference)
...
**Step 3: Participant and Location Linking**
For each participant and location:
- Use `linked_id` from current_entities if the entity matches
...
{{
    "events": [
        {{
            ...
            "location": {{"mention": "John's hometown", "linked_id": "entity:john_s_hometown", "role": "location"}},
            "inferred_time": null,
            "new_facts": []
        }}
    ]
...
{{
    "events": [
        {{
            ...
            "location": {{"mention": "the conference", "linked_id": "entity:conference", "role": "location"}},
...
{{
    "events": [
        {{
            ...
            "location": {{"mention": "West County", "linked_id": "entity:west_county", "role": "location"}},
