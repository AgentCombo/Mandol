...
class GlobalInsightManager:
    ...
    def _incremental_merge(
        ...
        prompt = f"""Given existing global insights and new session insights, merge them intelligently into a global insight.
...
Output JSON only:"""
        ...
        messages: List[ChatMessage] = [
            {"role": "system", "content": GLOBAL_INSIGHT_MERGE_PROMPT},
        ...
        try:
            ...
            logger.error(f"Global insight merge failed: {e}, keeping old insights")
