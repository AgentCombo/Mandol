...
# Purpose: Extract LoCoMo entities used by the entity-relation graph construction workflow.
...
uv run python -m benchmark_locomo.dataset_maker.locomo_graph_maker.step1_locomo_entity_extractor
