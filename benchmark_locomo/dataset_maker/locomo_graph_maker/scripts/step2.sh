...
# Purpose: Generate LoCoMo entity relations from the extracted entity set.
...
uv run python -m benchmark_locomo.dataset_maker.locomo_graph_maker.step2_locomo_relation_generator
