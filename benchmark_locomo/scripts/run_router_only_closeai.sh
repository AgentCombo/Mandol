#!/bin/bash
# Purpose: launch LoCoMo router-only benchmark runs through CloseAI models.
...
# ==============================================================================
# LoCoMo 路由 Benchmark (Tower Router) - CloseAI API
#
...
echo "4 个 LoCoMo 路由 Benchmark 任务已启动 (CloseAI)。"
...
echo "可使用 'tail -f log_locomo_routed_4.1_aggressive_closeai.log' 实时查看进度。"
