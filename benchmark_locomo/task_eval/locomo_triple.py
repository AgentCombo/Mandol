...
class LoCoMoTriTowerBenchmark:
        ...
        try:
            if self.parallel_towers:
                return self._run_parallel_tri_tower_test(
                    sample_id, question, category, expected_answer, question_index=question_index
                )
            else:
    ...
    def _run_parallel_tri_tower_test(self,
                                     ...
                                     category: int,
                                     expected_answer: str,
                                     question_index: int = 0) -> Optional[TriTowerRetrievalResult]:
        ...
        if self.enable_second_stage_rerank and (l0_units or graph_units or episodic_units):
