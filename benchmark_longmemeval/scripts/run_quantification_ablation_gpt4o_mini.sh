...
# GPT-4o-mini generation and GPT-4o-mini judging.
...
# Generation model: gpt-4o-mini-closeai
...
OUTPUT_ROOT="benchmark_longmemeval/task_eval/results/longmemeval_quantification_ablation/gpt4o_mini"
LLM_MODEL="gpt-4o-mini-closeai"
...
ENTITY_TOP_K=40
FINAL_TOP_K=25
CASCADE_MAX_CONTEXT_TOKENS=2200
CASCADE_CLIFF_TOLERANCE=3.0
