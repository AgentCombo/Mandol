#!/bin/bash
# Purpose: launch LongMemEval router-only benchmark runs through OpenRouter
# models.
# Runs: benchmark_longmemeval.task_eval.benchmark_triple_router.
...
# ==============================================================================
# LongMemEval 路由 Benchmark (Tower Router) - OpenRouter API
#
...
echo "4 个 LongMemEval 路由 Benchmark 任务已启动 (OpenRouter)。"
...
echo "可使用 'tail -f log_lme_routed_4.1_aggressive_openrouter.log' 实时查看进度。"
