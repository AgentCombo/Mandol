...
# Purpose: Generate the raw message-level LongMemEval dataset used by the hierarchical workflow.
...
uv run python -m benchmark_longmemeval.dataset_maker.longmemeval_hierarchical.raw_longmemeval_generator
